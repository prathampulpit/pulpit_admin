...
@section('title') Claimed Rewards @endsection
    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Claimed Rewards</h2>
                    <!-- <ol class="breadcrumb">
                ...
                <div class="d-flex">
                    <div class="justify-content-center">
                        ...
                        <!-- <a class="btn btn-primary my-2 btn-icon-text" href="{{ route('admin.claimedRewards.create',['panel' => Session::get('panel')]) }}">
                            <i class="fe fe-plus mr-2"></i> {{ @trans('claimedRewards.add_claimedRewards') }} </a> -->
                    </div>
                </div>
            </div>
            <!-- End Page Header -->
                                            ...
                                            <table id="example" class="table table-striped table-bordered text-nowrap dataTables_wrapper dt-bootstrap4 no-footer">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><b>Datetime</b><a href="javascript:void(0)"
                                                                :class="classSort('datetime')" @click="sort('datetime')"></a>
                                                        </th>
                                                ...
                                                <tbody>
                                                    <tr v-for="(item,index) in items">
                                                        ...
                                                        <td v-if="item.status=='0'">
                                                            <a title="Change status" href="javascript:void(0)" @click="confirm(item.id)" class="btn ripple btn-primary btn-sm" data-toggle="modal" data-target="#filter">Claim Requested</a>
                                                        </td>
                                                        <td v-else>
                                                            <button type="button" class="btn ripple btn-success btn-sm">Rewarded</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
@include('admin.components.change_status')
...
<script>
    ...
    var user_indexUrlJson = "{{route('admin.claimedRewards.index_json',['panel' => Session::get('panel')])}}";
    var toggle_status_url = "{{url(Session::get('panel').'/users/toggle-status')}}";
    var user_deleteUrl = "{{route('admin.claimedRewards.destroy',['panel' => Session::get('panel')])}}";
...
<script type="text/javascript" src="{{ asset('js/admin/claimedRewards.js') }}"></script>
@endpush