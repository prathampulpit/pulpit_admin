...
@section('title') Subscription Used Coupon @endsection
    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">{{ @trans('subscriptionUsedCoupon.subscriptionUsedCoupon') }}</h2>
                    <!-- <ol class="breadcrumb">
                ...
                <div class="d-flex">
                    <div class="justify-content-center">
                        ...
                        <!-- <a class="btn btn-primary my-2 btn-icon-text" href="{{ route('admin.subscriptionUsedCoupon.create',['panel' => Session::get('panel')]) }}">
                            <i class="fe fe-plus mr-2"></i> {{ @trans('subscriptionUsedCoupon.add_subscriptionUsedCoupon') }} </a> -->
                    </div>
                </div>
            </div>
            <!-- End Page Header -->
                                        ...
                                        <div class="table-checkable">
                                            <table id="example" class="table table-striped table-bordered text-nowrap dataTables_wrapper dt-bootstrap4 no-footer">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th><b>Username</b><a href="javascript:void(0)"
                                                                :class="classSort('first_name')" @click="sort('first_name')"></a></th>
                                                        <th><b>Subscription Name</b><a href="javascript:void(0)"
                                                            :class="classSort('first_name')" @click="sort('first_name')"></a></th>
                                                        <th><b>Coupon Code</b><a href="javascript:void(0)"
                                                                :class="classSort('coupon_code')" @click="sort('coupon_code')"></a></th>
                                                        <th><b>No Of Days</b><a href="javascript:void(0)"
                                                                :class="classSort('no_of_days')" @click="sort('no_of_days')"></a>
                                                        </th>
                                                        <!-- <th><b>{{ @trans('subscriptionUsedCoupon.action') }}</b></th> -->
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr v-for="(item,index) in items">
                                                        ...
                                                        <!-- <td class="act-btn">                                
                                                            <a :href="'{{url(Session::get('panel').'/subscriptionUsedCoupon/edit')}}/'+ item.id" title="Edit"
...
<script>
    var user_indexUrlJson = "{{route('admin.subscriptionUsedCoupon.index_json',['panel' => Session::get('panel')])}}";
    var toggle_status_url = "{{url(Session::get('panel').'/users/toggle-status')}}";
    var user_deleteUrl = "{{route('admin.subscriptionUsedCoupon.destroy',['panel' => Session::get('panel')])}}";
...
<script type="text/javascript" src="{{ asset('js/admin/subscriptionUsedCoupon.js') }}"></script>
@endpush