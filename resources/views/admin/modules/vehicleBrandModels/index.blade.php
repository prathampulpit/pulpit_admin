                    ...
                    <div class="d-flex">
                        <div class="justify-content-center">
                            ...
                            <a class="btn btn-primary my-2 btn-icon-text"
                                href="{{ route('admin.vehicleBrandModels.create', ['panel' => Session::get('panel')]) }}">
                                <i class="fe fe-plus mr-2"></i> {{ @trans('vehicleBrandModels.add_vehicleBrandModels') }}
                            </a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="table-checkable">
                                                <table id="example"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th><b>Vehicle Type</b><a href="javascript:void(0)"
                                                                    :class="classSort('vehicle_type_name')"
                                                                    @click="sort('vehicle_type_name')"></a>
                                                            </th>
                                                            <th><b>{{ @trans('vehicleBrandModels.brand_name') }}</b><a
                                                                    href="javascript:void(0)" :class="classSort('brand_id')"
                                                                    @click="sort('brand_id')"></a>
                                                            </th>
                                                            <th><b>{{ @trans('vehicleBrandModels.model_name') }}</b><a
                                                                    href="javascript:void(0)" :class="classSort('name')"
                                                                    @click="sort('name')"></a>
                                                            </th>
                                                            <th><b>{{ @trans('vehicleBrandModels.action') }}</b></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr v-for="(item,index) in items">
                                                            ...
                                                            <td>@{{ item.name }}</td>
                                                            <td class="act-btn">
                                                                <!-- <a :href="'{{ url(Session::get('panel') . '/vehicleBrandModels/show') }}/' +
                                                                item.id" title="View"
                                                                    class="btn-view btn-sm">
                                                                    <i class="material-icons">remove_red_eye</i>
                                                                </a> -->
                                                                <a :href="'{{ url(Session::get('panel') . '/vehicleBrandModels/edit') }}/' +
                                                                item.id"
...
@push('pageJs')
    ...
    <script>
        var user_indexUrlJson = "{{ route('admin.vehicleBrandModels.index_json', ['panel' => Session::get('panel')]) }}";
        var toggle_status_url = "{{ url(Session::get('panel') . '/users/toggle-status') }}";
        var user_deleteUrl = "{{ route('admin.vehicleBrandModels.destroy', ['panel' => Session::get('panel')]) }}";
    ...
    <script type="text/javascript" src="{{ asset('js/admin/vehicleBrandModels.js') }}"></script>
@endpush
