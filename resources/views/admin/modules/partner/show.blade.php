                                        ...
                                        <div class="d-sm-flex">
                                            ...
                                            <div class="row row-sm">                                            
                                                ...
                                                <div class="col-6 col-md-3 text-center">
                                                    ...
                                                    <img alt="docuemtn image" class="img-thumbnail" src="{{$user->agent_logo}}" onclick="getImage('{{$user->agent_logo}}','Agent Logo')">
                                                ...
                                                <div class="col-6 col-md-3 text-center">
                                                    ...
                                                    <img alt="docuemtn image" class="img-thumbnail" src="{{$user->pan_card_url}}" onclick="getImage('{{$user->pan_card_url}}','Pan Card')">

                                                    <span class="text-success" id="pan_card_url_status_approved" style="display:none;">Approved</span>
                                                    <span class="text-danger" id="pan_card_url_status_rejected" style="display:none;">Rejected</span>

                                                    @if( $user->pan_card_url_status == 2)
                                                        <button type="button" class="btn ripple btn-success btn-sm mt-2 pan_card_url_status_btn" onclick="documentVerify('agent','{{$user->agent_id}}','pan_card_url_status','1')">Approve</button>
                                                        <button type="button" class="btn ripple btn-danger btn-sm mt-2 pan_card_url_status_btn" onclick="documentVerify('agent','{{$user->agent_id}}','pan_card_url_status','0')">Reject</button>
                                                    @else
                                                ...
                                                <div class="col-6 col-md-3 text-center">
                                                    ...
                                                    <img alt="docuemtn image" class="img-thumbnail" src="{{$user->adhar_card_url}}" onclick="getImage('{{$user->adhar_card_url}}','Adhar Card')">

                                                    <span class="text-success" id="adhar_card_url_status_approved" style="display:none;">Approved</span>
                                                    <span class="text-danger" id="adhar_card_url_status_rejected" style="display:none;">Rejected</span>

                                                    @if( $user->adhar_card_url_status == 2)
                                                        <button type="button" class="btn ripple btn-success btn-sm mt-2 adhar_card_url_status_btn" onclick="documentVerify('agent','{{$user->agent_id}}','adhar_card_url_status','1')">Approve</button>
                                                        <button type="button" class="btn ripple btn-danger btn-sm mt-2 adhar_card_url_status_btn" onclick="documentVerify('agent','{{$user->agent_id}}','adhar_card_url_status','0')">Reject</button>
                                                    @else
