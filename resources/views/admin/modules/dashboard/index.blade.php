            ...
            <div class="row" style="    margin: 10px 0 0 0;">
                <div class="col-sm-12 col-lg-12 col-xl-12">
                    <div class="card card-box">
                        <form method="post" action="{{ route('admin.dashboard.filter', ['panel' => Session::get('panel')]) }}" class="" id="selectForm2" name="selectForm2" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="col-lg-4">
                                        <select class="form-control" id="vehicle_type_id" name="vehicle_type_id">
                                            ...
                                            <?php foreach ($vehicle_types as $r) { ?>
                                                <option value="<?= $r['id'] ?>" @if ($vehicleType==$r['id']) selected @endif><?= $r['name'] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-1">
                                        <div class="table-top-panel d-flex align-items-center">
                                            <div class="form-group select btm-arrow mb-0 d-flex without-label align-items-center">
                                                <button type="submit" class="btn ripple btn-primary">Search</button>
                                                <!-- <i class="material-icons" style="cursor: pointer;" v-if="start_date" @click="clearSearch">close</i> -->
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-lg-3" style="float:right;display: flex;justify-content: space-evenly;">
                                        <div class="onlineDriver">
                                            <div style="display:flex;">
                                                <!-- <i class="ti-search" style="padding-right:5px;"></i> -->
                                                <div style="padding:2px 4px 7px 2px;">
                                                    <div class="square1" style=" height: 1rem;width:1rem;background-color: green;"></div>
                                                </div>
                                                <b>{{ $onlineDrivers }}</b>
                                            </div>
                                            <div>
                                        ...
                                        <div class="offlineDriver">
                                            <div style="display:flex;">
                                                <div style="padding:2px 4px 7px 2px;">
                                                    <div class="square" style=" height: 1rem;width:1rem;background-color: grey;"></div>
                                                </div>
                                                <!-- <i class="ti-search" style="padding-right:5px;"></i> -->
                                                <b>{{ $offlineDrivers }}</b>
                                            </div>
                                        ...
                                        <div class="onGoingTripDriver">
                                            <div style="display:flex;">
                                                <div style="padding:2px 4px 7px 2px;">
                                                    <div class="square" style=" height: 1rem;width:1rem;background-color: blue;"></div>
                                                </div>
                                                <!-- <i class="ti-search" style="padding-right:5px;"></i> -->
                                                <b>{{ $onGoingDrivers }}</b>
                                            </div>
...
<div class="row row-sm" style="margin-top:26px;">
    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-4">
        <div class="card custom-card">
            <div class="card-body" onclick='location.href = "{{ route('admin.transactions.index', ['panel' => Session::get('panel')]) }}";' role="button">
                <div class="card-item">
    ...
    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-4">
        <div class="card custom-card">
            <div class="card-body" onclick='location.href = "{{ route('admin.register.index', ['panel' => Session::get('panel'), 'sub' => 'subscribe']) }}";' role="button">
                <div class="card-item">
                    <div class="card-item-icon card-icon">
                    ...
                    <div class="card-item-title mb-2">
                        <label class="main-content-label tx-13 font-weight-bold mb-1">{{ @trans('dashboard.number_of_users_subscribed') }}</label>
                        <span class="d-block tx-12 mb-0 text-muted"></span>
                    </div>
                    <div class="card-item-body">
                        <div class="card-item-stat">
    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-4">
        <div class="card custom-card">
            <div class="card-body" onclick='location.href = "{{ route('admin.trip.index', ['panel' => Session::get('panel'), 'param' => 'complete']) }}";' role="button">
                <div class="card-item">
                    <div class="card-item-icon card-icon">
                    ...
                    <div class="card-item-title  mb-2">
                        <label class="main-content-label tx-13 font-weight-bold mb-1">{{ @trans('dashboard.total_trips_completed') }}</label>
                        <span class="d-block tx-12 mb-0 text-muted"></span>
                    </div>
                    <div class="card-item-body">
                        <div class="card-item-stat">
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-item">
                    ...
                    <div class="card-item-title  mb-2">
                        <label class="main-content-label tx-13 font-weight-bold mb-1">{{ @trans('dashboard.agents_total_earning') }}</label>
                        <span class="d-block tx-12 mb-0 text-muted"></span>
                    </div>
                    <div class="card-item-body">
                        <div class="card-item-stat">
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-item">
                    ...
                    <div class="card-item-title  mb-2">
                        <label class="main-content-label tx-13 font-weight-bold mb-1">{{ @trans('dashboard.driver_total_earning') }}</label>
                        <span class="d-block tx-12 mb-0 text-muted"></span>
                    </div>
                    <div class="card-item-body">
                        <div class="card-item-stat">
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="card-item">
                    ...
                    <div class="card-item-title  mb-2">
                        <label class="main-content-label tx-13 font-weight-bold mb-1">{{ @trans('dashboard.Customers_total_spent') }}</label>
                        <span class="d-block tx-12 mb-0 text-muted"></span>
                    </div>
                    <div class="card-item-body">
                        <div class="card-item-stat">
        ...
        <div class="card custom-card">
            <div class="card-body" onclick='location.href = "{{ route('admin.register.index', ['panel' => Session::get('panel'), 'sub' => 'pending']) }}";' role="button">
                <div class="card-item">
                    ...
                    <div class="card-item-title  mb-2">
                        <label class="main-content-label tx-13 font-weight-bold mb-1">{{ @trans('dashboard.pending_approvals_user') }}</label>
                        <span class="d-block tx-12 mb-0 text-muted"></span>
                    </div>
                    <div class="card-item-body">
                        <div class="card-item-stat">
    ...
    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-4">
        <div class="card custom-card">
            <div class="card-body" onclick='location.href = "{{ route('admin.register.index', ['panel' => Session::get('panel'), 'sub' => 'complete']) }}";' role="button">
                <div class="card-item">
                    <div class="card-item-icon card-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
...
<div class="col-sm-12 col-lg-12 col-xl-4 mt-xl-4">
    ...
    <div class="card custom-card">
        ...
        <div class=" card-dashboard-calendar pb-0">
            <table class="table table-hover m-b-0 transcations mt-2">
                <tbody>
                    <?php foreach ($trans as $val) { ?>
                        <tr class="recent_trans_name">
                            <td class="wd-5p">
                                <div class="main-img-user avatar-md">
                                    <img alt="avatar" class="rounded-circle mr-3" src="{{ asset('assets/img/users/5.jpg') }}">
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="text-right">
                                <div class="d-inline-block">
                                    <h6 class="mb-2 tx-15 font-weight-semibold">₹<?= $val['price'] ?><i class="ml-2 text-success m-l-10"></i></h6>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-cncl" @click="resetAllFilter">{{ @trans('user.reset_all') }}</button>
            </div>
        </div>
    </div>
</div>
