        ...
        <div class="right-sec" v-cloak>
            ...
            <div class="top-bar d-flex align-items-center">
                ...
                <div class="right-table-container ml-auto">
                    ...
                    @if($user_role == 'writer')
                    <a href="{{ route('admin.cms_pages.create',['panel' => Session::get('panel')]) }}"
                        class="btn btn-em btn-primary-em">{{ @trans('cms_pages.add_cms') }}</a>
                    @endif
                </div>
            </div>
                    ...
                    <div class="table-responsive table-checkable">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ @trans('cms_pages.name') }}<a href="javascript:void(0)"
                            ...
                            <tbody>
                                <tr v-for="(item,index) in items">
                                    ...
                                    <td class="act-btn">
                                        ...
                                        <a :href="'{{url('/cms/')}}/'+ item.slug" target="_blank" title="Edit"
                                            class="btn btn-edit"><i class="material-icons">remove_red_eye</i>
                                        </a>
                                        <a :href="'{{url(Session::get('panel').'/cms_pages/edit')}}/'+ item.id" title="Edit"
...
<script type="text/javascript" src="{{ asset('js/admin/cms_pages.js') }}"></script>
@endpush