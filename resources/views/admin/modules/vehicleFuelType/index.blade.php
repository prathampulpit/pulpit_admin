...
@section('title') Vehicle Fuel Type @endsection
    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">{{ @trans('vehicleFuelType.vehicleFuelType') }}</h2>
                    <!-- <ol class="breadcrumb">
                ...
                <div class="d-flex">
                    <div class="justify-content-center">
                        ...
                        <a class="btn btn-primary my-2 btn-icon-text" href="{{ route('admin.vehicleFuelType.create',['panel' => Session::get('panel')]) }}">
                            <i class="fe fe-plus mr-2"></i> {{ @trans('vehicleFuelType.add_vehicleFuelType') }} </a>
                    </div>
                </div>
            </div>
            <!-- End Page Header -->
                                        ...
                                        <div class="table-checkable">
                                            <table id="example" class="table table-striped table-bordered text-nowrap dataTables_wrapper dt-bootstrap4 no-footer">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <!-- <th><b>{{ @trans('vehicleFuelType.model_name') }}</b><a href="javascript:void(0)"
                                                                :class="classSort('model_name')" @click="sort('model_name')"></a>
                                                        </th> -->
                                                        <th><b>{{ @trans('vehicleFuelType.name') }}</b><a href="javascript:void(0)"
                                                                :class="classSort('name')" @click="sort('name')"></a>
                                                        </th>
                                                        <th><b>{{ @trans('vehicleFuelType.action') }}</b></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr v-for="(item,index) in items">
                                                        ...
                                                        <td>@{{ item.name }}</td>
                                                        <td class="act-btn">                                
                                                            <!-- <a :href="'{{url(Session::get('panel').'/vehicleFuelType/show')}}/'+ item.id" title="View"
                                                                class="btn-sw btn-view">
                                                                <i class="material-icons">remove_red_eye</i>
                                                            </a> -->                                        
                                                            <a :href="'{{url(Session::get('panel').'/vehicleFuelType/edit')}}/'+ item.id" title="Edit"
                                                                class="btn-sw btn-edit"><i class="material-icons">edit</i>
                                                            </a>       
                                                            <a href="javascript:void(0)" @click="confirm(item.id)" title="Delete"
                                                                class="btn-sw btn-edit"><i class="material-icons">delete</i>
                                                            </a>                 
                                                        </td>
                                                    </tr>
                                                </tbody>
...
<script>
    var user_indexUrlJson = "{{route('admin.vehicleFuelType.index_json',['panel' => Session::get('panel')])}}";
    var toggle_status_url = "{{url(Session::get('panel').'/users/toggle-status')}}";
    var user_deleteUrl = "{{route('admin.vehicleFuelType.destroy',['panel' => Session::get('panel')])}}";
...
<script type="text/javascript" src="{{ asset('js/admin/vehicleFuelType.js') }}"></script>
@endpush