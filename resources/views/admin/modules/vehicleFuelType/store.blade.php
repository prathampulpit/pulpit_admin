                ...
                <div class="col-xl-6 col-lg-12 col-md-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            <div>
                                @if($id)
                                <h6 class="main-content-label mb-1">{{ @trans('vehicleFuelType.edit_vehicleFuelType') }}</h6>
                                @else
                                <h6 class="main-content-label mb-1">{{ @trans('vehicleFuelType.add_vehicleFuelType') }}</h6>
                                @endif
                                <p class="text-muted card-sub-title">&nbsp;</p>
                            </div>
                            <form method="post" action="{{ route('admin.vehicleFuelType.store',['panel' => Session::get('panel')]) }}" class="parsley-style-1" id="selectForm2" name="selectForm2">
                                @csrf
                                ...
                                <input type="hidden" name="model_id" id="model_id" value="1">
