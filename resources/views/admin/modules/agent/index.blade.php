        ...
        <div class="container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">{{ @trans('agent.agent') }} {{ @trans('agent.users') }}
                        </h2>
                        <!-- <ol class="breadcrumb">
                    ...
                    <form method="post" action="{{ route('admin.agent.index', ['panel' => Session::get('panel')]) }}"
                        class="" id="selectForm2" name="selectForm2" enctype="multipart/form-data">
                        <div class="row">
                            @csrf
                            <div class="col-lg-4">
                                <select class="form-control" id="state_id1" name="state_id" style="margin-left: -28px;"
                                    onchange="getCity1()">
                                ...
                                <div class="card custom-card">
                                    <div class="row row-sm">
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'day']) }}";'>
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'yesterday']) }}";'>
                                            <div class="card-body text-center">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'week']) }}";'>
                                            <div class="card-body text-center">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'this_month']) }}";'>
                                            <div class="card-body text-center">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'last_month']) }}";'>
                                            <div class="card-body text-center">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel')]) }}";'>
                                            <div class="card-body text-center">
                            ...
                            <div class="col-md-12">
                                <div class="card custom-card">
                                    <div class="row row-sm">
                                        <!--  -->
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'fiften_days']) }}";'>
                                            <div class="card-body text-center">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'inactive']) }}";'>
                                            <div class="card-body text-center">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'paid']) }}";'>
                                            <div class="card-body text-center">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'unpaid']) }}";'>
                                            <div class="card-body text-center">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer"
                                            onclick='location.href = "{{ route('admin.agent.index', ['panel' => Session::get('panel'), 'filter' => 'expired_users']) }}";'>
                                            <div class="card-body text-center">
                                                ...
                                                <table id="example"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th><b>Image</b></th>
                                                            <th><b>Agent Name</b><a href="javascript:void(0)"
                                                            ...
                                                            <th><b>State - City</b><a href="javascript:void(0)"
                                                                    :class="classSort('user_type')"
                                                                    @click="sort('user_type')"></a></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td v-else>
                                                            ...
                                                            <td v-else>
                                                                <img src="{{ asset('noimage.png') }}" width='50'
                                                                    style=" height: 4rem !important;
                                                            border-radius: 50px !important;
                                                            width: 4rem !important;" />
                                                            </td>

                                                            <td><a :href="'{{ url(Session::get('panel') . '/agent/show') }}/' + item.id"
                                                                    title="View">
                                                            ...
                                                            <td v-if="item.start_datetime != 'null'">
                                                                @{{ formatDate(item.start_datetime) }}</td>
                                                            <td v-else>-</td>
                                                            <td v-if="item.end_datetime != 'null'">
                                                            ...
                                                            <td v-else>
                                                                ...
                                                                <a :href="'{{ url(Session::get('panel') . '/users/resendotp') }}/' +
                                                                item.id" class="btn ripple btn-danger btn-sm">Not Verify</a>
                                                            </td>
                                                            ...
                                                            <td class="act-btn">
                                                                <a :href="'{{ url(Session::get('panel') . '/agent/show') }}/' +
                                                                item.id"
                                                                    title="View" class="btn-sm btn-view">
                                                                    <i class="material-icons">remove_red_eye</i>
                                                                </a>
                                                                <!-- <a :href="'{{ url(Session::get('panel') . '/agent/edit') }}/' +
                                                                item.id" title="Edit"
...
@push('pageJs')
    ...
    <script>
        var user_indexUrlJson =
            "{{ route('admin.agent.index_json', ['panel' => Session::get('panel'), 'filter' => $filter]) }}";
        var toggle_status_url = "{{ url(Session::get('panel') . '/agent/toggle-status') }}";
        var user_deleteUrl = "{{ route('admin.agent.destroy', ['panel' => Session::get('panel'), 'id' => 1]) }}";
    ...
    <script type="text/javascript" src="{{ asset('js/admin/agent.js') }}"></script>
