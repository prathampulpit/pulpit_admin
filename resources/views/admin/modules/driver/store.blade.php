                ...
                <div class="col-xl-10 col-lg-12 col-md-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.driver.store',['panel' => Session::get('panel')]) }}" class="parsley-style-1" id="selectForm2" name="selectForm2" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row row-sm mg-b-20">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mg-b-10 row" id="fnWrapper">
                                            ...
                                            <div class="col-lg-2">
                                                <label class="rdiobox"><input name="usertype" id="usertype" type="radio" value="4" @if($id) @if($user_type_id == 4) checked  @endif checked @endif >
                                ...
                                <div class="row row-sm mg-b-20">
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-control" name="state" id="state" required="" onchange="getCities()">
                                            <option value="" label="Choose one"></option>
                                ...
                                <div class="row row-sm mg-b-20 bank">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input class="form-control bank" value="@if(!empty($bank)) @if(old('ifsc_code')){{old('ifsc_code')}}@elseif($id){{$bank['ifsc_code']}}@endif @endif" name="ifsc_code" placeholder="Enter {{@trans('user.ifsc_code')}}" required="" type="text">
                                    </div>
                                </div>
                                <div class="row row-sm mg-b-20 bank">
                                    <div class="col-lg-6">
