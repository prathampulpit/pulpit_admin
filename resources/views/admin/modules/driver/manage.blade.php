...
<form method="post" action="{{ route('admin.driver.save',['panel' => Session::get('panel')]) }}" class="parsley-style-1" id="selectForm2" name="selectForm2" enctype="multipart/form-data">
    ...
    <div class="row row-sm mg-b-20">
        <div class="col-lg-6">
            ...
            <input class="form-control driver" value="@if(old('license_no')){{old('license_no')}}@elseif($id && !empty($data)){{$data->driving_licence_no}}@endif" name="license_no"  id="license_no" placeholder="Enter {{@trans('user.license_no')}}" required="" type="text">
        </div>
        <div class="col-lg-4">
            <p class="mg-b-10">Birth Date</p>
            <input class="form-control" value="@if(!empty($data)){{date('Y-m-d',strtotime($data->dob))}}@endif" name="dob" id="driver_bod" placeholder="Enter Date of Birth" required="" type="date">
        </div>
        <div class="col-lg-2">
        ...
        <div class="col-lg-4" style='margin-top: 5px;'>
            ...
            <div class="mg-b-10" id="fnWrapper">
                <input class="form-control"  name="first_name" id="first_name" placeholder="Enter {{@trans('user.first_name')}}" 
                       required="" type="text" 
                       maxlength="50"
                       value="@if(!empty($data)){{$data->first_name}}@endif"
                       >
            </div>
        </div>
        ...
        <div class="col-lg-4" style='margin-top: 5px;'>
            ...
            <div class="mg-b-10" id="fnWrapper">
                <input class="form-control"  name="last_name" 
                       ...
                       value="@if(!empty($data)){{$data->last_name}}@endif"
                       >
            </div>
        </div>
        <div class="col-lg-4" style='margin-top: 5px;'>
            ...
            <div class="mg-b-10" id="fnWrapper">
                <input class="form-control" value="@if(!empty($data)){{$data->father_name}}@endif" name="father_name" id="father_name" placeholder="Enter Father Name" required="" type="text" maxlength="50">
            </div>
        </div>
        <div class="col-lg-6" style='margin-top: 5px;'>
            ...
            <div class="mg-b-10" id="fnWrapper">
                <textarea class="form-control"  name="street_address" id="street_address"  
                    placeholder="Enter Address" required="">@if(!empty($data)){{$data->street_address}}@endif </textarea>
            </div>
        </div>
<!--        <div class="col-lg-6" style='margin-top: 5px;'>
            <p class="mg-b-10">{{ @trans('user.email') }}: <span class="tx-danger">*</span></p>
            <div class="mg-b-10" id="fnWrapper">
                <input class="form-control" value="@if(old('emailid')){{old('emailid')}}@elseif($id && !empty($data)){{$user->emailid}}@endif" name="emailid" placeholder="Enter {{@trans('user.email')}}" required="" type="text" maxlength="100">
            </div>
        </div>-->
      
        <div class="col-lg-4" style='margin-top: 5px;'>
            <p class="mg-b-10">{{ @trans('user.pin_code') }}</p>
            <input class="form-control driver" value="@if(!empty($data)){{$data->pincode}}@endif" id="pincode" name="pin_code" placeholder="Enter {{@trans('user.pin_code')}}" required="" type="text">
        </div>
        <div class="col-lg-4">
            <p class="mg-b-10">{{ @trans('user.states') }}</p>
            <input type="text"  class="form-control" required="" name="state_id" id="state_id" value="@if(!empty($data)){{$data->state}}@endif">
                
            
        </div>
        <div class="col-lg-4">
            <p class="mg-b-10">{{ @trans('user.city') }}</p>
            <input type="text" class="form-control" name="city_id" id="city_id" required="" value="@if(!empty($data)){{$data->city}}@endif"> 
          ...
          <div class="col-lg-4" style='margin-top: 5px;'>
            ...
            <input class="form-control driver" value="@if(old('year_of_experience')){{old('year_of_experience')}}@elseif($id && !empty($data)){{$data->year_of_experience}}@endif" id="year_of_experience" name="year_of_experience" placeholder="Enter Year Of Experience" required="" type="text">
        </div>
        <div class="col-lg-6" style='margin-top: 5px;'>
            ...
            <div class="mg-b-10" id="fnWrapper">
                <input class="form-control" value="@if(old('mobile_number')){{old('mobile_number')}}@elseif($id && !empty($data)){{$user->mobile_number}}@endif" name="mobile_number" placeholder="Enter {{@trans('user.mobile_number')}}" required="" type="text" maxlength="10">
            </div>
        </div>
        ...
        <div class="col-lg-4" style='margin-top: 5px;'>
            ...
            <input class="form-control driver fc-datepicker hasDatepicker" value="@if(old('expiry_date')){{old('expiry_date')}}@elseif($id && !empty($data)){{$data->driving_licence_expiry_date}}@endif" name="expiry_date" id="expiry_date" placeholder="YYYY-MM-DD" required="" type="date">
        </div>
        <div class="col-lg-3">
            <p class="mg-b-10">Issue Date</p>
            <input class="form-control driver fc-datepicker hasDatepicker" name="issue_date" id="issue_date" placeholder="YYYY-MM-DD" required="" type="date" value="@if(!empty($data)){{$data->issue_date}}@endif">
        </div>
        <!--        <div class="col-lg-6">
                    <p class="mg-b-10">{{ @trans('user.street_address') }}</p>
                    <input class="form-control driver" value="@if(old('street_address')){{old('street_address')}}@elseif($id && !empty($data)){{$data->street_address}}@endif" name="street_address" placeholder="Enter {{@trans('user.street_address')}}" required="" type="text">
                </div>-->
    ...
    <div class="row row-sm mg-b-20 travel">
        <div class="col-lg-4">
            ...
            <div class="mg-b-10" id="fnWrapper">
                <input type="file" name="logo" id="logo" class="dropify travel" data-height="200" @if(!$id) required="" @else data-default-file="@if(!empty($data->logo)){{$data->logo}}@endif" @endif/>
            </div>
        </div>
