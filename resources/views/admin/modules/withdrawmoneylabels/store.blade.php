...
@section('title')
@if($id)
Edit Withdraw Money Labels
@else
Add Withdraw Money Labels
@endif
                        ...
                        <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                            <div class="step-box">
                                <form id="frmAddEditUser" method="post"
                                    action="{{ route('admin.withdrawmoneylabels.store',['panel' => Session::get('panel')]) }}" enctype="multipart/form-data">
                                    @csrf

                                    <div class="form-body">
                                        @if($id)
                                        <h2 class="form-sec-title">{{ @trans('withdraw_money_labels.edit_withdraw_money_label') }}</h2>
                                        <input type="hidden" name="id" value="{{$id}}">
                                        @else
                                        <h2 class="form-sec-title">{{ @trans('withdraw_money_labels.withdraw_money_label') }}</h2>
                                        @endif

                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">{{ @trans('withdraw_money_labels.display_name') }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">{{ @trans('withdraw_money_labels.display_name_sw') }}
                                                    <span class="required">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">{{ @trans('withdraw_money_labels.sub_title') }}
                                                    <span class="required">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">{{ @trans('withdraw_money_labels.sub_title_sw') }}
                                                    <span class="required">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group file-upload">
                                                    <label class="control-label">{{ @trans('withdraw_money_labels.icon') }}</label>
                                            ...
                                            <div class="col-md-12 previewDiv">
                                                <div class="thumbnail-wrapper">
                                                    <img width="100" height="100" class="preview"
                                                        src="{{ env('APP_URL') . '/storage/' }}{{ config('custom.upload.withdrawmoney') }}/{{ $item['icon'] }}">
...
{!! JsValidator::formRequest('App\Http\Requests\WithdrawMoneyLabels\StoreWithdrawMoneyLabels', '#frmAddEditUser') !!}
<script>
@if($id)
    $('.deleteLogo').click(function() {
        var deleteLogoUrl = "{{ route('admin.withdrawmoneylabels.delete_icon',['panel' => Session::get('panel')])}}";
        var id = "{{ $item->id }}";
