    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Rental Trip Fare Details</h2>
                    <ol class="breadcrumb">
                        ...
                        <div class="tab-content">
                            <div class="main-content-body tab-pane p-4 border-top-0 active" id="about">
                                <div class="card-body p-0 border p-0 rounded-10">
                                    ...
                                    <div class="p-4">
                                        <label class="main-content-label tx-13 mg-b-20">Rental Trip Fare - Website</label>
                                        <div class="d-sm-flex">
                                    ...
                                    <div class="p-4">
                                        <label class="main-content-label tx-13 mg-b-20">Rental Ranges</label>
                                        <div class="">
                                            @if(!empty($ranges))
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                                                    <div class="mg-sm-r-40 mg-b-10">
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> <span>Hours</span> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                                                    <div class="mg-sm-r-40 mg-b-10">
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> <span>KM</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> 
                                                                    <div>{{$row->hours}} Hours - {{$row->km}} KM</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
