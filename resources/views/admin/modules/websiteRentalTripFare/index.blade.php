    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">{{ @trans('tripFare.rental') }} {{ @trans('tripFare.tripFare') }} - {{ @trans('tripFare.website') }}</h2>
                    <!-- <ol class="breadcrumb">
                ...
                <div class="d-flex">
                    <div class="justify-content-center">
                        ...
                        <a class="btn btn-primary my-2 btn-icon-text" href="{{ route('admin.websiteRentalTripFare.create',['panel' => Session::get('panel')]) }}">
                            <i class="fe fe-plus mr-2"></i>{{ @trans('tripFare.add') }} {{ @trans('tripFare.rental') }} {{ @trans('tripFare.tripFare') }} </a>
                    </div>
                </div>
            </div>
            <!-- End Page Header -->
                                            ...
                                            <table id="example" class="table table-striped table-bordered text-nowrap dataTables_wrapper dt-bootstrap4 no-footer">
                                                ...
                                                <tbody>
                                                    <tr v-for="(item,index) in items">
                                                        ...
                                                        <td class="act-btn">                                
                                                            <a :href="'{{url(Session::get('panel').'/websiteRentalTripFare/show')}}/'+ item.id" title="View"
                                                               class="btn-view btn-sm">
                                                                <i class="material-icons">remove_red_eye</i>
                                                            </a>                                        
                                                            <a :href="'{{url(Session::get('panel').'/websiteRentalTripFare/edit')}}/'+ item.id" title="Edit"
...
<script>
    var user_indexUrlJson = "{{route('admin.websiteRentalTripFare.index_json',['panel' => Session::get('panel')])}}";
    var toggle_status_url = "{{url(Session::get('panel').'/users/toggle-status')}}";
    var user_deleteUrl = "{{route('admin.websiteRentalTripFare.destroy',['panel' => Session::get('panel')])}}";
...
<script type="text/javascript" src="{{ asset('js/admin/websiteRentalTripFare.js') }}"></script>
@endpush