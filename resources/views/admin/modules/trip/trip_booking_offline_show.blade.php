...
@section('title')
{{ @trans('trip.website') }} {{ @trans('trip.trip') }}
@endsection
        ...
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.vehicles.index',['panel' => Session::get('panel')]) }}">{{ @trans('trip.website') }} {{ @trans('trip.trip') }}</a></li>
                                        ...
                                        <div class="d-sm-flex"> 
                                            <div class="row col-md-12">
                                                <table style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>{{$trip_booking->order_id}}</td>
                                                            <td>{{$trip_booking->KM}} KM</td>
                                                            <td>₹ {{$trip_booking->grand_total}}</td>
                                                            <td>₹ {{$trip_booking->advance_booking_amount}}</td>
                                                            <td>{{$trip_booking->advance_booking}} %</td>
                                                            <td>{{$trip_booking->GST}} %</td>
                                                            <td>₹ {{$trip_booking->GSTCalculate}}</td>
 
                                                            <td>
                                                                @if($trip_booking->payment_status == "PAID")
                                                                <b>₹ {{$trip_booking->grand_total - $trip_booking->advance_booking_amount}}</b>
                                                                @else
                                                                <b>₹ {{$trip_booking->grand_total}}</b>
                                                                @endif
                                                            </td>
                                                            <td>
                                                                @if($trip_booking->payment_status == "PAID")
                                                                <span class="btn btn-success btn-sm">{{$trip_booking->payment_status}}</span>
                                                                @else
                                                                <span class="btn btn-danger btn-sm">{{$trip_booking->payment_status}}</span>
                                                                @endif
                                                            </td>
                                                ...
                                                <div class="col-md-2 pl-0">
                                                    <div class="mg-sm-r-20 mg-b-10">
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> 
                                                                    <?php $url = url(Session::get('panel') . '/customer-trip-offline'); ?>
...
<?php $url = url(Session::get('panel') . '/trip/customer_trip_offline/update_status'); ?>
