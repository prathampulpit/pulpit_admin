        ...
        <div class="right-sec" v-cloak>
            ...
            <div class="top-bar d-flex align-items-center">
                ...
                <div class="right-table-container ml-auto">
                    ...
                    <a href="{{ route('admin.providers.create',['panel' => Session::get('panel')]) }}"
                        class="btn btn-em btn-primary-em">{{ @trans('provider.add_provider') }}</a>
                </div>
            </div>
                    ...
                    <div class="table-responsive table-checkable">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ @trans('provider.name') }}<a href="javascript:void(0)"
                            ...
                            <tbody>
                                <tr v-for="(item,index) in items">
                                    ...
                                    <td class="act-btn">
                                        ...
                                        <a :href="'{{url(Session::get('panel').'/providers/edit')}}/'+ item.id" title="Edit"
...
<script>
    var indexUrlJson = "{{route('admin.providers.index_json',['panel' => Session::get('panel')])}}";
    var deleteUrl = "{{url(Session::get('panel').'/providers/destroy')}}";
...
<script type="text/javascript" src="{{ asset('js/admin/providers.js') }}"></script>
@endpush