    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">{{ @trans('tripFare.outstation') }} {{ @trans('tripFare.tripFare') }}</h2>
                ...
                <div class="col-xl-8 col-lg-12 col-md-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            <div>
                                @if($id)
                                <h6 class="main-content-label mb-1">{{ @trans('tripFare.outstation') }} {{ @trans('tripFare.edit_tripFare') }} - {{ @trans('tripFare.website') }}</h6>
                                @else
                                <h6 class="main-content-label mb-1">{{ @trans('tripFare.outstation') }} {{ @trans('tripFare.add_tripFare') }} - {{ @trans('tripFare.website') }}</h6>
                                @endif
                                <p class="text-muted card-sub-title">&nbsp;</p>
                            </div>
                            <form method="post" action="{{ route('admin.websiteOutStationTripFare.store',['panel' => Session::get('panel')]) }}" class="parsley-style-1" id="selectForm2" name="selectForm2" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row  row-sm mg-b-20">
                                    ...
                                    <div class="col-lg-4">
                                        <p class="mg-b-10">Driver Allowances: <span class="tx-danger">*</span></p>
                                        <div class="mg-b-10" id="fnWrapper">
                                            <input class="form-control" value="@if(old('driver_allowances')){{old('driver_allowances')}}@elseif($id){{$data->driver_allowances}}@endif" name="driver_allowances" placeholder="Enter Driver Allowances" required="" type="text" onkeyup="if (/[^0-9\.]/g.test(this.value))
                                                        this.value = this.value.replace(/[^0-9\.]/g, '')">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <p class="mg-b-10">Per KM: <span class="tx-danger">*</span></p>
                                        <div class="mg-b-10" id="fnWrapper">
                                            <input class="form-control" value="@if(old('per_km')){{old('per_km')}}@elseif($id){{$data->per_km}}@endif" name="per_km" placeholder="Enter Per KM" required="" type="text" onkeyup="if (/[^0-9\.]/g.test(this.value))
                                                        this.value = this.value.replace(/[^0-9\.]/g, '')">
                                        </div>
                                    </div>
...
<!--
                                <div class="row " style="display: none;">  
                                    ...
                                    <div class="col-md-12">  
                                        <div class="row">  
                                            <div class="col-lg-3">
                                                <p class="mg-b-10">KM/Day: <span class="tx-danger">*</span></p> 
                                            </div>
                                            <div class="col-lg-3">
                                    ...
                                    <div class="col-md-12">  
                                        ...
                                        <div id="ranges">
                                            ...
                                            <div class="row row-sm mg-b-20" id="remove_ranges{{$i}}">  
                                                <div class="col-lg-3">
                                                    <div class="mg-b-10" id="fnWrapper">
                                                        <input class="form-control" value="@if(old('km_per_day')){{old('km_per_day')}}@elseif($id){{$row->km_per_day}}@endif" name="km_per_day[]" placeholder="Enter Hours" required="" type="text"  onkeyup="if (/[^0-9\.]/g.test(this.value))
                                                                    this.value = this.value.replace(/[^0-9\.]/g, '')">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row row-sm mg-b-20">  
                                                <div class="col-lg-3">
                                                    <div class="mg-b-10" id="fnWrapper">
                                                        <input class="form-control" value="0" name="km_per_day[]" placeholder="Enter Hours" required="" type="text"  onkeyup="if (/[^0-9\.]/g.test(this.value))
                                                                    this.value = this.value.replace(/[^0-9\.]/g, '')">
                                                    </div>
                                                </div>
                                ...
                                <div class="mg-t-30">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="{{ url('/super-admin/websiteOutStationTripFare')}}" class="btn ripple btn-danger pd-x-20 btn-block">Back</a>    
                                        </div>
                                    </div>
...
<script>
    ...
    $('body').on('click', '#add_range', function () {
        ...
        html += '<input class="form-control" value="0" name="km_per_day[]" placeholder="Enter Hours" required="" type="text" onkeyup="if (/[^0-9\.]/g.test(this.value)) this.value = this.value.replace(/[^0-9\.]/g, "")">';
        html += '</div>';
        html += '</div>';
        html += '<div class="col-lg-3">';
        html += ' <div class="mg-b-10" id="fnWrapper">';
    ...
    $('body').on('click', '#add_more', function () {
        ...
        html += '<div class="col-lg-3">';
        html += '<div class="mg-b-10" id="fnWrapper">';
        html += '<input class="form-control" name="km_per_day" required="" type="number" placeholder="From KM Range">';
        html += '</div>';
        html += '</div>';
        html += '<div class="col-lg-3">';
        html += '<div class="mg-b-10" id="fnWrapper">';
