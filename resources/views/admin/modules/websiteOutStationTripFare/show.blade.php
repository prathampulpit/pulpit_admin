    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">OutStation Trip Fare Details</h2>
                    <ol class="breadcrumb">
                        ...
                        <div class="tab-content">
                            <div class="main-content-body tab-pane p-4 border-top-0 active" id="about">
                                <div class="card-body p-0 border p-0 rounded-10">
                                    ...
                                    <div class="p-4">
                                        <label class="main-content-label tx-13 mg-b-20">OutStation Trip Fare - Website</label>
                                        <div class="d-sm-flex">
                                            <div class="row col-md-12">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mg-sm-r-40 mg-b-10">
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> <span>Driver Allowances</span>
                                                                    <div>{{$tripFare->driver_allowances}}</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mg-sm-r-40 mg-b-10">
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> <span>Per KM</span>
                                                                    <div>{{$tripFare->per_km}}</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<!--                                    @if(!empty($ranges))
                                    <div class="p-4">
                                        <label class="main-content-label tx-13 mg-b-20">OutStation Ranges</label>
                                        <div class="">
                                            <div class="row">
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                                    <div class="mg-sm-r-40 mg-b-10">
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> <span>KM/Day</span> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                                    <div class="mg-sm-r-40 mg-b-10">
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> <span>Prices</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> 
                                                                    <div>{{$row->km_per_day}} KM</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                                    <div class="mg-sm-r-40 mg-b-10">
                                                        <div class="main-profile-contact-list">
                                                            <div class="media">
                                                                <div class="media-body"> 
