                        ...
                        <div>
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.users.index', ['panel' => Session::get('panel')]) }}">User</a>
                                </li>
                                                        ...
                                                        <div class="row col-md-12">
                                                            ...
                                                            <div class="col-md-3 pl-0">
                                                                <div class="mg-sm-r-40 mg-b-10">
                                                                    <div class="main-profile-contact-list">
                                                                        <div class="media">
                                                                            <div class="media-body"> <span>State
                                                                                    Name</span>
                                                                                <div class="user_edit">
                                                                                    {{ $user->state_name }}
                                                                                </div>
                                                            ...
                                                            <div class="row col-md-12">
                                                                ...
                                                                <div class="col-md-3 pl-0">
                                                                    <div class="mg-sm-r-40 mg-b-10">
                                                                        <div class="main-profile-contact-list">
                                                                            <div class="media">
                                                                                <div class="media-body"> <span>Bank
                                                                                        Name</span>
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="row row-sm">
                                                            ...
                                                            ?>
                                                                    ...
                                                                    &nbsp; <button type="button"
                                                                        class="btn ripple btn-primary btn-sm mt-2"
                                                                        onclick="imageUpload('bank_account','{{ $banks->id }}','bank_document_url_status','document_url','travel')">Change
                                                                        Image</button>
                                                                </div>
                                                            @endif
                                                        </div>
