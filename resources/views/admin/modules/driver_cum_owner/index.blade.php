...
@section('title') Driver Cum Owner @endsection
    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Driver Cum Owner</h2>
                    <!-- <ol class="breadcrumb">
                ...
                <form method="post" action="{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel')]) }}" class="" id="selectForm2" name="selectForm2" enctype="multipart/form-data">
                    <div class="row">                        
                        @csrf
                        <div class="col-lg-4">
                            <select class="form-control" id="state_id1" name="state_id" style="margin-left: -28px;" onchange="getCity1()">
                                ...
                                <option value="<?= $r['id']; ?>" @if($state_id == $r['isoCode']) selected @endif><?= $r['name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4 plan_lists1">
                            <select class="form-control" id="plan_id1" name="plan_id" style="margin-left: -28px;">
                                <option value="all" selected>Select Subscription Plan</option>
                                <?php foreach($plans as $r){?>
                                <option value="<?= $r['id']; ?>" @if($plan_id == $r['id']) selected @endif><?= $r['name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                ...
                <div class="col-sm-8 col-lg-8 col-xl-8">
                    <div class="row row-sm"> 
                        <div class="col-md-12"> 
                            <div class="card custom-card"> 
                                <div class="row row-sm"> 
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'day']) }}";'> 
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'yesterday']) }}";'> 
                                        <div class="card-body text-center"> 
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'week']) }}";'> 
                                        <div class="card-body text-center"> 
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'this_month']) }}";'> 
                                        <div class="card-body text-center"> 
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'last_month']) }}";'> 
                                        <div class="card-body text-center"> 
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel')]) }}";'> 
                                        <div class="card-body text-center"> 
                    ...
                    <div class="row row-sm"> 
                        <div class="col-md-12"> 
                            <div class="card custom-card"> 
                                <div class="row row-sm"> <!--  -->
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'fiften_days']) }}";'> 
                                        <div class="card-body text-center"> 
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'inactive']) }}";'>
                                        <div class="card-body text-center"> 
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'paid']) }}";'> 
                                        <div class="card-body text-center"> 
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'unpaid']) }}";'> 
                                        <div class="card-body text-center"> 
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-sm-6 pe-0 ps-0 border-end pointer" onclick='location.href = "{{ route('admin.driver_cum_owner.index',['panel' => Session::get('panel'),'param'=>'expired_users']) }}";'> 
                                        <div class="card-body text-center"> 
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <select class="form-control" id="state_id" v-model="state_id" style="margin-left: -28px;" onchange="getCity()">
                                ...
                                <div class="col-lg-2">
                                    <select class="form-control" id="vehicle_type_id" style="margin-left: -28px;" onchange="getPlans()">
                                        <option value="" selected>Select Vehicle Types</option>
                                        <?php foreach($vehicle_types as $r){?>
                                        <option value="<?= $r['id']; ?>"><?= $r['name']; ?></option>
                                        <?php } ?>
                                ...
                                <div class="col-lg-2 plan_lists">
                                    <select class="form-control" id="plan_id" v-model="plan_id" style="margin-left: -28px;">
                            ...
                            <div class="row">
                                <div class="table-responsive table-data" v-if="items.length">                                
                                    <div class="col-sm-12">
                                        <div class="table-checkable table-scrollable" style="height: 500px; overflow-x: scroll;">
                                            ...
                                            <thead>
                                                    <tr>
                                                        ...
                                                        <th><b>Plan Type</b></th>
                                                        <th><b>Subscription Started On</b><a href="javascript:void(0)"
                                                            :class="classSort('user_purchased_plans.start_datetime')" @click="sort('user_purchased_plans.start_datetime')"></a></th>
                                                        <th><b>Subscription End On</b><a href="javascript:void(0)"
                                                            :class="classSort('user_purchased_plans.end_datetime')" @click="sort('user_purchased_plans.end_datetime')"></a></th>
                                                ...
                                                <tbody>
                                                    <tr v-for="(item,index) in items"><!-- danger -->
                                                        ...
                                                        <td><a :href="'{{url(Session::get('panel').'/driver_cum_owner/show')}}/'+ item.id" title="View" >
                                                        ...
                                                        <td><a :href="'{{url(Session::get('panel').'/driver_cum_owner/show')}}/'+ item.id" title="View" >@{{ item.mobile_number }}</a></td>

                                                        <td v-if="item.availability_status=='1'">
                                                            <button type="button" class="btn ripple btn-success btn-sm">Online</button>
                                                        </td>
                                                        <td v-else>
                                                            <button type="button" class="btn ripple btn-danger btn-sm">Offline</button>
                                                        </td>

                                                        <td v-if="item.created_at!='-0001-11-30 00:00:00'">@{{ formatDate(item.created_at) }}</td>
                                                        <td v-else>-</td>
                                                        <td>@{{ item.subscription_name }}</td>
                                                        <td v-if="item.start_datetime !=''">@{{ formatDate(item.start_datetime) }}</td>
                                                        <td v-else>-</td>
                                                        ...
                                                        <td class="act-btn">                                
                                                            <a :href="'{{url(Session::get('panel').'/driver_cum_owner/show')}}/'+ item.id" title="View" 
                                                                class="btn-sm btn-view">
                                                                <i class="material-icons">remove_red_eye</i>
                                                            </a><!--                                         
                                                            <a :href="'{{url(Session::get('panel').'/driver_cum_owner/edit')}}/'+ item.id" title="Edit"
...
<script>
    var user_indexUrlJson = "{{route('admin.driver_cum_owner.index_json',['panel' => Session::get('panel'),'filter'=>$filter])}}";
    var toggle_status_url = "{{url(Session::get('panel').'/driver_cum_owner/toggle-status')}}";
    var user_deleteUrl = "{{route('admin.driver_cum_owner.destroy',['panel' => Session::get('panel'), 'id' => 1])}}";
...
<script type="text/javascript" src="{{ asset('js/admin/driver_cum_owner.js') }}"></script>
