        ...
        <div class="right-sec" v-cloak>
            ...
            <div class="top-bar d-flex align-items-center">
                ...
                <div class="right-table-container ml-auto">
                    ...
                    <a href="{{ route('admin.faqs.create',['panel' => Session::get('panel')]) }}"
                        class="btn btn-em btn-primary-em">{{ @trans('faq.add_faq') }}</a>
                </div>
            </div>
                    ...
                    <div class="table-responsive table-checkable">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ @trans('faq.question') }}<a href="javascript:void(0)"
                                            :class="classSort('question')" @click="sort('question')"></a>
                                    </th>
                                    <th>{{ @trans('faq.answer') }}<a href="javascript:void(0)"
...
<script>
    var indexUrlJson = "{{route('admin.faqs.index_json',['panel' => Session::get('panel')])}}";
    var deleteUrl = "{{url(Session::get('panel').'/faqs/destroy')}}";
