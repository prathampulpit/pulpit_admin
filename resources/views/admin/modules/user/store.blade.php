                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.users.store',['panel' => Session::get('panel')]) }}" class="parsley-style-1" id="selectForm2" name="selectForm2" enctype="multipart/form-data">
                                ...
                                @endif                                
                                <input type="hidden" name="usertype" id="usertype" value="6">
...
$(document).ready(function() {
    ...
    $('#state').on('change', function() {
        ...
        $.ajax({
            url: '{{ route("admin.users.statecity") }}',
            type: "POST",
            data: {
                id: state_id
            },
    ...
    $('#model_id').on('change', function() {
        ...
        $.ajax({
            url: '{{ route("admin.users.vehicleFuelType") }}',
            type: "POST",
            data: {
                id: model_id
            },
        ...
        $.ajax({
            url: '{{ route("admin.users.vehicleColour") }}',
            type: "POST",
            data: {
                id: model_id
            },
