...
<div class="main-header side-header sticky">
    <div class="container-fluid">
        ...
        <!-- <h2 class="main-content-title tx-24 mg-b-5" style="margin-right: 74rem;">Welcome To Pulpit</h2> -->
        ...
        <div class="main-header-right">
            ...
            <div class="dropdown main-profile-menu">
                ...
                <div class="dropdown-menu">
                    <div class="header-navheading">
                        <h6 class="main-notification-title">Yogesh Pulpit</h6>
                    ...
                    <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#modalLogoutConfirm">
                        <i class="fe fe-power"></i> {{ @trans('sidebar.sign_out') }}
                    </a>
                </div>
            </div>
