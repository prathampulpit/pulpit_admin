...
bt.tree.config = {
    ...
    materialicons: {
        ...
        icons: {
            expand: '<i class="material-icons orange">add</i>',
            collapse: '<i class="material-icons orange">remove</i>'
        }
    },
...
bt.tree.methods = {
    ...
    appendNode: function ($tree, $parent, nodeData, level, position) {
        var i, $node, $newParent, $span, $img,
            data = $tree.data(),
            $node = $('<li data-id="' + nodeData.id + '" class="level-'+ level +'" data-role="node" data-value="'+ nodeData.data.id +'"/>').addClass(data.style.item),
...
bt.tree.plugins.checkboxes = {
    ...
    public: {
        ...
        getCheckedNodes: function () {
            var result = [],
                checkboxes = this.find('li.level-3 [data-role="checkbox"] input[type="checkbox"]');
            $.each(checkboxes, function () {
                var checkbox = $(this);
                if (checkbox.checkbox('state') === 'checked') {
                    result.push(checkbox.closest('li').data('value'));
                }
            });
            return result;
        },
