var app = new Vue({
    ...
    methods: {
        ...
        AuthroziedConfirm(id) {
            this.entity_id = id;
            $('#modalAuthorizedConfirm').modal();
        },
        formatDate(date) {
        ...
        authorized() {
            let vm = this;
            alert(user_authorized);
            axios.post(user_authorized + '/' + vm.entity_id)
                .then(function (response) {
                    vm.get();
                    vm.entity_id = '';
                    Snackbar.show({
                        pos: 'bottom-right',
                        text: 'Driver Authorized Successfully!',
                        actionText: 'Okay'
                    });
                    $('#modalAuthorizedConfirm').modal('hide');
                });
