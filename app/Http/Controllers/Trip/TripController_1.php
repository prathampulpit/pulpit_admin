...
class TripController extends Controller {
    ...
    public function store(Request $request) {
        ...
        $notificationText = "Hello, New " . $trip_type . " Trip Posted, Pickup Location: " . $pickupLocation . ", Pickup Date: " . Str::substr($request->pickup_date_time, 0, 10);
    ...
    public function customer_trip_offline_visitor_details(Request $request) {
        ...
        $results = DB::table('trip_bookings_offline_visitor')
                ->leftJoin('website_local_trip_fare', 'website_local_trip_fare.id', '=', 'trip_bookings_offline_visitor.vehicle_id')
                ->leftJoin('vehicle_types', 'vehicle_types.id', '=', 'website_local_trip_fare.vehicle_type_id')
